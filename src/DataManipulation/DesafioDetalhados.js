    ...
    <div className="container">
      ...
      {desafios.map((desafio) => (
        <div key={desafio.id} className="cartao">
          ...
          <button onClick={() => exibirDetalhes(desafio.id)} className="botao">Exibir detalhes</button>
          <button onClick={() => excrudDesafio(desafio.id)} className="botao">Excluir</button>
          <button onClick={() => setEditDesafio({ ...desafio })} className="botao">Editar</button>
        </div>
      ))}
      ...
      {modalAberto && detalhesDesafio && (
        <div className="modal">
          <div className="modal-content">
            <button className="close-modal" onClick={fecharJanela}>X</button>
            ...
            <p><strong>Autor:</strong> {detalhesDesafio.displayName || ''}</p>
            <ul>
